...
const s = {
  ...
  sidebarEmail: { color: '#4a6a8a', fontSize: '12px', margin: '2px 0 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  nav: { display: 'flex', flexDirection: 'column', gap: '2px', flex: 1 },
  navItem: {
    padding: '8px 12px', borderRadius: '8px',
    color: '#5a7a9a', fontSize: '13px', fontWeight: '500',
